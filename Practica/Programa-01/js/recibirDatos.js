...
const tablaGastosPersonales = document.querySelector('#get-table tbody');

/*Seleccionando la tabla de visualización del total de ingresos*/
const tablaTotalIngresos = document.querySelector('#get-table-2 tbody');

//Btn
const btn = document.getElementById('btn-submit');

export default class RecibirDatos {
